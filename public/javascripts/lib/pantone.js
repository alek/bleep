var getPantoneColorsIDs = function() {
  return Object.keys(pantoneColors)
}

var randomPantone = function() {  
  var colors = Object.keys(pantoneColors);
  return pantoneColors[colors[Math.floor(Math.random()*colors.length)]];
}

var randomPantoneHex = function() {  
  return "#" + randomPantone()["hex"];
}

var getPantone = function(index) {
  var colors = Object.keys(pantoneColors);
  return pantoneColors[colors[index%colors.length]];
}

var getPantoneHex = function(index) {
  return "#" + getPantone(index)["hex"]
}
